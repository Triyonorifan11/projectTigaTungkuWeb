...
function isLogin() {
  if (localStorage.getItem('webTigaTungku')) {
    return true;
  }
  return false;
}
...
function getUserInfo() {
  if (isLogin()) {
    return JSON.parse(localStorage.getItem('webTigaTungku'));
  }
  return null;
}
...
export {
  isLogin, getUserInfo, escapeHtml, redirect, uploadFile, formatDate, formatRupiah, flassMessage,
};
